...
#include<iostream>//using standard libraries
#include<string.h>
#include<stdlib.h>

using namespace std;

class book	{ //first we record the book information and store it in a class called "book"
private:
...
void book::feeddata()	{//now using class book we ask for user specific inputs 
	cin.ignore();
